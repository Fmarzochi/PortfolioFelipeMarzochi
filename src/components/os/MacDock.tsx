...
const DOCK_ITEMS: DockItem[] = [
  { id: 'safari',   title: 'Portfólio',           icon: UserIcon,        gradient: 'from-blue-500 to-cyan-500'                 },
  { id: 'maps',     title: 'Experiência',          icon: ClockIcon,       gradient: 'from-emerald-500 to-teal-600'              },
