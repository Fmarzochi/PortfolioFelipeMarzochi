  ...
  const processCommand = (cmd: string) => {
    ...
    switch (trimmedCmd) {
      ...
      case 'about':
        output = (
          <p className="leading-relaxed">
            ...
            em transição ativa para Java com Spring Boot e JPA no back-end.<br/>
      ...
      case 'projects':
        output = (
          <div className="flex flex-col gap-1.5">
            ...
            {[
              ['ERP para Gestão de Negócios',          'Java · React.js · PostgreSQL'],
              ['Laboratório Unilab',                   'Next.js · Tailwind CSS · Framer Motion'],
              ["Felipe's Dream Agent",                 'Python · Gemini API · GitHub Actions'],
      ...
      case 'contact':
        output = (
          <div className="flex flex-col gap-1">
            <p><span className="text-green-400">E-mail    </span> fmarzochi@gmail.com</p>
