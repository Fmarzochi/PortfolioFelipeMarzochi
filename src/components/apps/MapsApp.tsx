...
const EXPERIENCES: Experience[] = [
  {
    ...
    color: 'bg-violet-500',
    location: { x: 12, y: 22 },
    activities: 'Engenharia do ecossistema front end do Conecta 360°, plataforma SaaS estratégica para gestão de RH e conformidade NR 1. Lidero a estruturação da interface com React.js e TypeScript, estabelecendo padrões de arquitetura de componentes e rigorosa tipagem estática. Responsável pela integração de APIs REST, fluxos de autenticação, controle de permissões e orquestração do ambiente via Docker com persistência em PostgreSQL.',
