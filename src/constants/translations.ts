  ...
  en: {
    ...
    projects: {
      ...
      '7': {
        ...
        tag: 'Next.js · Node.js · PostgreSQL · Docker',
        dor: 'The professional required a complete digital presence capable of integrating, in a single environment, the institutional presentation and the operational management of the business. Scheduling, patient administration, financial control, cash flow, and content production were all handled manually and in a decentralized way, compromising the efficiency and scalability of the operation.',
        solucao: 'Development of a custom web platform using Next.js on the frontend and Node.js on the backend, bringing together an institutional website, scheduling system, blog, patient management, financial control with cash flow tracking, and an admin panel with secure authentication. The infrastructure was built with PostgreSQL containerized in Docker to ensure performance, organization, and scalability.',
        resultado: 'Deployment of a complete platform in production, digitally consolidating the professional\'s 9 years of experience into a modern, centralized ecosystem. The system eliminated manual processes, optimized operational management, and unified all areas of the business into a single custom web solution.',
      },
    },
  },
  ...
  es: {
    ...
    projects: {
      ...
      '7': {
        ...
        tag: 'Next.js · Node.js · PostgreSQL · Docker',
        dor: 'La profesional requería una presencia digital completa, capaz de integrar en un único entorno la presentación institucional y la gestión operacional del negocio. Los procesos de agendamiento, administración de pacientes, control financiero, flujo de caja y producción de contenido se realizaban de forma manual y descentralizada, comprometiendo la eficiencia y la escalabilidad de la operación.',
        solucao: 'Desarrollo de una plataforma web personalizada utilizando Next.js en el frontend y Node.js en el backend, reuniendo sitio institucional, sistema de agendamiento, blog, gestión de pacientes, control financiero con flujo de caja y panel administrativo con autenticación segura. La infraestructura fue estructurada con PostgreSQL en contenedor Docker para garantizar rendimiento, organización y escalabilidad.',
        resultado: 'Implementación de una plataforma completa en producción, consolidando digitalmente los 9 años de experiencia de la profesional en un ecosistema moderno y centralizado. El sistema eliminó procesos manuales, optimizó la gestión operacional y concentró todas las áreas del negocio en una solución web personalizada.',
      },
    },
  },
};
